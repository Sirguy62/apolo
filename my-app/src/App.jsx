...
const videos = [
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431288/43801B6E-FCFA-4388-8BC1-73152EB95A82_t9cjjh.mp4", caption: "" },
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431282/1C8640AB-624C-4FCE-9A53-8B2D03E885FE_m1m4nl.mp4", caption: "" },
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431323/E0C0A4AB-99D9-47CB-A829-8BCDD280D12E_uyde5v.mp4", caption: "My world through your eyes" },
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431316/C1948365-7FCA-4FAF-BD12-44FABA0B32CF_uw3o8w.mp4", caption: "My little duty" },
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431338/BDCA250D-E8EB-4DCB-A39F-DE318C656E51_rqqibq.mp4", caption: "" },
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431362/183FE9F9-5012-4E8D-B9D2-2DEFBD347BC6_tfwhp9.mp4", caption: "" },
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431303/C3ABD3C2-60C7-4901-9AFC-DC8CA6D7184A_pwcgxk.mp4", caption: "" },
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431387/AAB7F11F-7108-4114-A932-26FB8DCCB581_p4gu5r.mp4", caption: "Our early days" },
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431680/459A25CA-78B3-4CB8-ABA1-48F3A3ECD652_x9a3ps.mp4", caption: "Where every moment matters" },
  { src: "https://res.cloudinary.com/dasbpn3sm/video/upload/v1779431690/5E9F0F13-11FD-4EAA-9B26-126B35283353_uhbsgn.mp4", caption: "Happy i was here" },
];

const accentColors = ["#c0392b", "#8e44ad", "#1abc9c", "#e8b86d", "#dd15b5", "#d4856a", "#c0392b", "#8e44ad", "#1abc9c", "#e8b86d"];
...
export default function App() {
  ...
  const goTo = (index, dir) => {
    ...
    setDirection(dir);
    setAnimating(true);
    setTimeout(() => { setCurrent(index); setAnimating(false); }, 480);
  };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {Array.from({ length: TOTAL }).map((_, i) => (
          <button key={i} onClick={() => goTo(i, i > current ? "next" : "prev")} style={{
            ...
            background: i === current ? (slide ? slide.accent : "#fff") : "rgba(255,255,255,0.25)",
      ...
      <div style={{
        ...
        justifyContent: "center", zIndex: 1, padding: "0 24px",
      }}>
        <div key={current} style={{
          width: "100%",
          opacity: animating ? 0 : 1,
          transform: animating
            ? direction === "next" ? "translateX(60px) scale(0.96)" : "translateX(-60px) scale(0.96)"
            : "translateX(0) scale(1)",
          transition: "opacity 0.45s ease, transform 0.45s ease",
        }}>
          {!isVideoSlide
            ? <RomanticSlide slide={slide} />
            : <VideoGallery onVideoClick={setModalVideo} />
          }
        </div>
      </div>
      ...
      <div style={{
        ...
        <NavButton onClick={prev} disabled={current === 0} label="← Prev" accent={slide?.accent} />
        <span style={{ color: "rgba(255,255,255,0.3)", fontSize: 13, fontFamily: "monospace", letterSpacing: 3 }}>
          {String(current + 1).padStart(2, "0")} / {String(TOTAL).padStart(2, "0")}
        </span>
        <NavButton onClick={next} disabled={current === TOTAL - 1} label="Next →" accent={slide?.accent} primary />
      </div>
...
function RomanticSlide({ slide }) {
  return (
    <div style={{ textAlign: "center", padding: "60px 24px" }}>
      <div style={{
        fontSize: 36, color: slide.accent, marginBottom: 32,
        opacity: 0.7, animation: "pulse 3s ease-in-out infinite",
      }}>
        {slide.symbol}
      </div>
      <div style={{
  ...
  return (
    <div style={{ padding: "40px 0" }}>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        ...
        <h2 style={{
          fontSize: "clamp(1.6rem, 4vw, 2.8rem)", fontWeight: 400,
          color: "#fff", fontStyle: "italic", letterSpacing: "0.04em", marginBottom: 12,
        }}>
          Moments That Last Forever
        </h2>
        <p style={{
          color: "rgba(255,255,255,0.45)", fontSize: 15,
          letterSpacing: "0.12em", fontFamily: "sans-serif", textTransform: "uppercase",
        }}>
          a collection of us
        </p>
        <div style={{
      ...
      <div style={{
        ...
        gap: 16, maxWidth: 720,
        margin: "0 auto", padding: 14,
      }}>
        {videos.map((v, i) => (
          <VideoCard key={i} video={v} index={i} onClick={() => onVideoClick({ ...v, index: i })} />
        ))}
      </div>
    </div>
  );
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered ? `0 0 40px ${color}55` : `0 0 30px ${color}22`,
        cursor: "pointer",
    ...
    >
      ...
      <div style={{
        ...
        background: hovered
          ...
          : `linear-gradient(to top, ${color}cc 0%, transparent 55%)`,
...
function VideoModal({ video, onClose }) {
  const ref = useRef(null);
  const color = accentColors[video.index % accentColors.length];
  ...
  return (
    <div onClick={onClose} style={{
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        ...
        boxShadow: `0 0 100px ${color}44, 0 40px 80px rgba(0,0,0,0.9)`,
        animation: "scaleIn 0.35s cubic-bezier(0.34, 1.56, 0.64, 1)",
      }}>
        {/* Close button top-right */}
        <button onClick={onClose} style={{
          position: "absolute", top: 12, right: 12, zIndex: 10,
          background: "rgba(0,0,0,0.6)", border: `1px solid ${color}88`,
        ...
        {/* Video */}
        <video ref={ref} src={video.src} controls autoPlay playsInline
          style={{ width: "100%", display: "block", background: "#000", maxHeight: "75vh", objectFit: "contain" }}
        />

        {/* Bottom bar — only show if there's a caption */}
        {video.caption ? (
          <div style={{
            background: `linear-gradient(to right, #0a0a0a, ${color}22)`,
            padding: "14px 24px",
